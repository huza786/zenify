          ...
          child: Padding(
            ...
            child: CustomScrollView(
              slivers: [
                            ...
                            children: [
                              IconButton(
                                onPressed: () {
                                  ...
                                  productPageProvider
                                      .addPhotoReviews(product.reviews);
                ...
                productPageProvider.photosOrNot
                    ?
                    //Review Card after filteration i.e with photos
                    SliverList(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                """${productPageProvider.photoReviews[reviewIndex].createdAt.month.toString()} ${productPageProvider.photoReviews[reviewIndex].createdAt.day.toString()},${productPageProvider.photoReviews[reviewIndex].createdAt.year.toString()}""",
                                                style: headerStyle.copyWith(
                                                    fontSize: 11,
                                                    color: Colors.grey),
                                              )
                    ...
                    :
                    //review card before filteration
                    SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (context, reviewIndex) => SizedBox(
                            width: 327.w,
                            ...
                            child: Stack(
                              children: [
                                ...
                                CircleAvatar(
                                  backgroundImage: AssetImage(
                                    product
                                        .reviews[reviewIndex].userProfilePhoto,
                                  ),
                                  radius: 16,
                                ),
                              ],
